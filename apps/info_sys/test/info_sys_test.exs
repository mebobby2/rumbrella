defmodule InfoSysTest do
  ...
  test "compute/2 with timeout returns no results and kills workers" do
    ...
    # to confirm that no further :DOWN or :timedout messages are in our inbox. When we wrote
    # the compute function, we made sure that the code cleans up after itself, guaranteeing
    # it doesn’t leave messages in the process inbox. Those assertions help us validate our cleanup code.
