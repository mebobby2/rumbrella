defmodule Rumbl.VideoChannel do
  ...
  def join("videos:" <> video_id, params, socket) do
    ...
    resp = %{ annotations: Phoenix.View.render_many(annotations, AnnotationView, "annotations.json") }
  ...
  defp broadcast_annotation(socket, annotation) do
    ...
    rendered_ann = Phoenix.View.render(AnnotationView, "annotations.json", %{ annotation: annotation })
